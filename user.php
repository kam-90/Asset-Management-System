...
if(isset($_POST['submit']))
{
  ...
  $email=$_POST['email'];
  $pass=$_POST['pass'];
  $permission1=$_POST['permiss'];
  $ams=$_POST['select'];
  

   $query = 'INSERT INTO users
                 (UserName,UserEmail,UserPassword,UserPermission,SystemID)
              VALUES
                 ( :name,:email,:pass1,:permiss,:sysID)';
                    ...
                    $statement->bindValue(':permiss',$permission1);
     ...
     <div class="container">    
        <div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">                    
            ...
            <div class="panel-heading">
                        <div class="panel-title"><h3>Create User</h3></div>
             ...
             <div style="padding-top:30px" class="panel-body" >
                        ...
                        <form id="adminform" name="admin" method="POST" action="user.php" class="form-horizontal" role="form">
                            ...
                            <div style="margin-bottom: 25px" class="input-group">
                                ...
                                <div style="margin-bottom: 25px" class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-lock">Select User Permission</i></span>
                                        <select id="permission" class="form-control" name="permiss">
                                                  <option>Read</option>
                               ...
                               <select id="warranty" class="form-control" name="select">
                                ...
                                <div style="margin-top:10px" class="form-group">
                                    ...
                                    <div class="col-sm-12 controls">
                                      ...
                                      <button id="btn-login" type="submit" name="submit" class="btn btn-success">Create User</button>
